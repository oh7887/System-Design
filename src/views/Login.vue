...
const Login = () => {
  router.push({name:"HomeView",children:[{name:"CreateProgram"}]});
  console.log(router.push({name:"HomeView",children:[{name:"CreateProgram"}]}));
};
      ...
      <div class="fogot-pwd">
        ...
        <div class="form">
          ...
          <div class="code input-item">
            <input type="text" class="ipts" />
            <span class="veri-code-tips">点击获取</span>
          </div>
